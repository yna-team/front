...
import { useMainSection04 } from "./hook";

export const MainSection04 = () => {
    const { DATA } = useMainSection04();
    ...
    return (
        <section className="pb-6">
            ...
            <div className="space-y-6 px-4">
                {DATA.map((data, i) => (
                    <article key={i} className="flex items-start gap-[14px]">
                        ...
                        <div className="min-w-0 flex-1 pt-1">
                            ...
                            <div className="mt-[2px] text-[18px] font-bold tracking-[-0.3px] text-[#191919]">
                                {(
                                    Math.floor((data.price * (100 - data.salePer) * 0.01) / 100) *
                                    100
                                ).toLocaleString()}
                                원
                            </div>
